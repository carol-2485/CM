...
class ChatRespostaCentroScreen extends StatefulWidget {
  ...
  const ChatRespostaCentroScreen({
    super.key,
  ...
  @override
  State<ChatRespostaCentroScreen> createState() =>
      _ChatRespostaCentroScreenState();
}
...
class _ChatRespostaCentroScreenState extends State<ChatRespostaCentroScreen> {
  ...
  void initState() {
    super.initState();
    _chatService.marcarComoLido(widget.chatId, 'centro');
  }
