// lib/features/perfil/widgets/cartao_info_perfil.dart
...
class CartaoInfoPerfil extends StatelessWidget {
  final List<LinhaInfo> linhas;
  const CartaoInfoPerfil({super.key, required this.linhas});
